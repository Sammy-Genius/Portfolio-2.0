    ...
    return ( 
        <div className="w-full h-full">
            <div className="w-full h-auto text-white opacity-0 reveal">
                <h1 className="uppercase text-primary-color text-5xl md:text-7xl xl:text-9xl font-black text-center mt-[100px] text-shadow-3">samuel osei</h1>
                <div className="w-[90%] lg:w-[50%] my-[30px] mx-auto text-lg">
                    <p className="uppercase mt-5"><span className="text-xl text-primary-color font-black">current Status:</span> Available for full/part time roles, gigs, contracts, internships and collaborations. <a href="mailto:mrsammadeit@gmail.com" className="underline text-primary-color">let's talk!</a></p>
