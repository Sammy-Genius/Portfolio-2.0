    ...
    return ( 
        <>
            <div className="clip-circle-menu flex flex-col justify-center lg:hidden">
                <span className="text-white absolute top-[5%] right-[10%] text-2xl close-btn">&times;</span>
                <div className="w-[80%] h-[50%] text-white text-3xl flex flex-col items-center justify-evenly mx-auto my-0">
