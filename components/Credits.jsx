                ...
                <div className="w-full md:w-[80%] h-auto text-white text-lg flex flex-col mt-[80px] translate-x-0 credits-container px-4">
                    ...
                    <div className="mt-[60px]">
                        <div className="flex flex-col">
                            ...
                            <p className="inline-block lg:hidden w-full lg:w-[50%]">This design concept was inspired by <a href="https://www.studiolumio.com/" className="underline">Studio Lumio</a> and Apple's Dynamic Island</p>
                            <p className="hidden lg:inline-block w-full lg:w-[50%]">This design concept was inspired by <a href="https://www.studiolumio.com/" className="underline">Studio Lumio</a>. I always admired the design concept and art direction for their website. With the blessings of the lead designer at Studio Lumio, I got to use this design concept for my portfolio.</p>
                            <p className="hidden lg:inline-block w-[80%] lg:w-[50%] mt-3">Also, the micro interactions and concept for the nav bar was inspired by Apple's Dynamic Island.</p>
                        </div>
                        <div className="mt-[60px]">
